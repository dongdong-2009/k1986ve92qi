...
void TimerConfig(void)
{
	...
	*/
	...
	MDR_TIMER3->CH1_DTG |= ((0xff&(60)) << 4); 					// delay DTG	
	MDR_TIMER3->CH2_DTG |= ((0xff&(60)) << 4); 					// delay DTG	
	MDR_TIMER3->CH3_DTG |= ((0xff&(60)) << 4); 					// delay DTG	
	MDR_TIMER3->CH4_DTG |= ((0xff&(60)) << 4); 					// delay DTG	
